...
namespace Batranu_Alexandru_Lab2.Controllers
{
    public class BooksController : Controller
    {
...

        {
            ...
            int pageSize = 2;
            return View(await PaginatedList<Book>.CreateAsync(books.Include(i=>i.Author).AsNoTracking(), pageNumber ?? 1, pageSize));
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,Author,Price")] Book book)
        {
            ...
            {
                ModelState.AddModelError("", "Unable to save changes." + "Try again, and if the problem persits");
            }
            return View(book);
        }
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            {
                ViewData["ErrorMessage"] = "Delete failed. TryAgain";
            }
